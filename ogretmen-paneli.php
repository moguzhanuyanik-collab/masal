...
<link rel="stylesheet" href="styles.css"><link rel="stylesheet" href="ogretmen.css?v=1.0.40"></head><body class="role-page"><div class="role-shell">
<header class="role-topbar"><a class="role-brand" href="ogretmen-paneli.php"><span>👩‍🏫</span><span><strong>Öğretmen</strong><small>ÖĞRENCİ TAKİBİ</small></span></a><div class="role-actions"><a class="role-icon" href="rol-paneli.php">🛡️</a><a class="role-icon" href="hesap-guvenligi.php">⚙️</a></div></header>
...
<section class="role-section"><div class="role-section-head"><div><span class="eyeline">ÖĞRENCİLERİM</span><h2>Bağlı Öğrenciler</h2></div></div><div class="role-list">
...
</main><nav class="role-bottom"><a class="active" href="ogretmen-paneli.php"><span>⌂</span>Panel</a><a href="rol-paneli.php"><span>🎒</span>Öğrenciler</a><a href="hesap-guvenligi.php"><span>⚙️</span>Hesap</a><a href="logout.php"><span>🚪</span>Çıkış</a></nav></div></body></html>