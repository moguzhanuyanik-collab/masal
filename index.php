...
<head>
  ...
  <link rel="stylesheet" href="adimbot-student.css?v=1.0.95">
  ...
  <script src="adimbot-student.js?v=1.0.95" defer></script>
  <script src="global-audio-feedback.js?v=1.0.95" defer></script>
