...
<link rel="stylesheet" href="styles.css"><link rel="stylesheet" href="yonetici.css?v=1.0.40"></head>
...
<?php if($institutionId>0):?><a class="role-primary" href="kurum-kullanicilari.php?kurum_id=<?=$institutionId?>">Kullanıcı Ekle →</a><?php endif;?><span class="role-hero-art">🏫</span></section>
...
<a class="role-module" href="kurum-kullanicilari.php?kurum_id=<?=$institutionId?>"><span>👥</span><div><strong>Kurum Kullanıcıları</strong><small>Öğrenci, veli ve öğretmen hesabı aç; eşleştirme yap.</small></div><b>→</b></a>
...
<nav class="role-bottom"><a class="active" href="yonetici-paneli.php?kurum_id=<?=$institutionId?>"><span>⌂</span>Panel</a><a href="kurum-kullanicilari.php?kurum_id=<?=$institutionId?>"><span>👥</span>Kullanıcılar</a><a href="rol-paneli.php"><span>🛡️</span>Yetkiler</a><a href="logout.php"><span>🚪</span>Çıkış</a></nav>
</div></body></html>