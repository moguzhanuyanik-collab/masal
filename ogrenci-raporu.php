...
$stmt=$pdo->prepare('SELECT id,email FROM ogrenciler WHERE id=? AND aktif=1 LIMIT 1');
...
<p>Bu rapor yalnızca hesabına yetkilendirilmiş öğrenci için görüntülenebilir.</p>
</section>
